...
function Content_App() {
  ...
  const memo = useMemo(() => {
    axios
      .get(
        `http://127.0.0.1:8000/content/4/${params.get('id')}/`,
  ...
  return (
    ...
    <div id="maindiv_3">
        <div id="specdiv">
          ...
          <h1 id="htxt">App info</h1>
          <div id="border-div">
          
          {Array.isArray(data["App_info"])
            ? data["App_info"].map((value) => {
                return (
        ...
        <div id="prosconsdiv">
          <div id="prodiv">
            <h1 id="htxt">User_Benfits</h1>
            <div id='border-div'>
            <text id="smalltxt">{data["user_benfits"]}</text>
            </div>
          </div>
        </div>
        <div id="prosconsdiv">
          <div id="prodiv">
            <h1 id="htxt">About this App</h1>
            <div id='border-div'>
            <text id="smalltxt">{data["about_app"]}</text>
            </div>
          </div>
        </div>
        <div id="commentdiv">
