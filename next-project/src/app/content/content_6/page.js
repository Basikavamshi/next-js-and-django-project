...
function Content_Game() {
  ...
  const memo = useMemo(() => {
    axios
      .get(
        `http://127.0.0.1:8000/content/6/${params.get('id')}/`,
  ...
  return (
    ...
    <div id="maindiv_3">
        <div id="specdiv">
          ...
          <h1 id="htxt">Game info</h1>
          <div id="border-div">
          
          {Array.isArray(data["game_info"])
            ? data["game_info"].map((value) => {
                return (
        ...
        <div id="prosconsdiv">
          <div id="prodiv">
            <h1 id="htxt">About this Game</h1>
            <div id='border-div'>
            <text id="smalltxt">{data["about_game"]}</text>
            </div>
          </div>
        </div>
        <div id="commentdiv">
