...
function Content() {
  ...
  const memo = useMemo(() => {
    axios
      .get(
        `http://127.0.0.1:8000/content/1/${params.get('id')}/`,
  ...
  return (
      ...
      <div id="mainc">
        ...
        <div id="mainimgdiv">
          ...
          <div id="scrooldotsdiv">
            ...
            <li id={`dots${activecircle == 1 ? "active" : ""}`}></li>
            <li id={`dots${activecircle == 2 ? "active" : ""}`}></li>
            <li id={`dots${activecircle == 3 ? "active" : ""}`}></li>
            <li id={`dots${activecircle == 4 ? "active" : ""}`}></li>
          </div>
        </div>
    ...
    <div id="maindiv_3">
        <div id="specdiv">
          ...
          <div>
          <h1 id="htxt">highlights</h1>
          <div id="border-div">
          
          {Array.isArray(data["specifications"])
            ? data["highlights"].map((value) => {
                return (
                  <h1 id="smalltxt" key={value.id}>
                    {value}
                  </h1>
        ...
        <div id="prosconsdiv">
          <div id="prodiv">
            <h1 id="htxt">pros</h1>
            <div id='border-div'>
            <text id="smalltxt">{data["pros"]}</text>
            </div>
          </div>
          <div id="consdiv">
            <h1 id="htxt">cons</h1>
            <div id="border-div">
            <text id="smalltxt">{data["cons"]}</text>
            </div>
          </div>
        </div>
        <div id="commentdiv">
